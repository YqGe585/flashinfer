...
dtype_map = {
    ...
    paddle.float8_e4m3fn: "__nv_fp8_e4m3",
    paddle.float8_e5m2: "__nv_fp8_e5m2",
    "int8": "int8_t",
    "uint8": "uint8_t",
    "int32": "int32_t",
    "uint32": "uint32_t",
...
dtype_cutlass_map = {
    ...
    paddle.float8_e4m3fn: "cutlass::float_e4m3_t",
    paddle.float8_e5m2: "cutlass::float_e5m2_t",
    "int8": "cutlass::int8_t",
    "uint8": "cutlass::uint8_t",
    "int32": "cutlass::int32_t",
    "uint32": "cutlass::uint32_t",
    "int64": "cutlass::int64_t",
    "uint64": "cutlass::uint64_t",
}
filename_safe_dtype_map = {
    "float16": "f16",
    "bfloat16": "bf16",
    paddle.float8_e4m3fn: "e4m3",
    paddle.float8_e5m2: "e5m2",
    "int8": "i8",
    "uint8": "u8",
    "int32": "i32",
    "uint32": "u32",
