...
class TaggedTensor:
    ...
    @staticmethod
    def logits(t: paddle.Tensor) -> TaggedTensor:
        """
    ...
    @staticmethod
    def probs(t: paddle.Tensor) -> TaggedTensor:
        """
    ...
    @staticmethod
    def indices(t: paddle.Tensor) -> TaggedTensor:
        """
    ...
    def size(self, dim: Optional[int] = None) -> (list | int):
        """
